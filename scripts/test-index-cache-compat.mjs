...
const lines = [
  ...
  '    sourceBlocksByFile: {},',
  '  };',
  "  assert.deepEqual(resolveIndexCacheCompatibility(previousParserCache), { state: 'invalidated' }, 'parser revision 2 cache should rebuild after empty-source parsing changes');",
  '}',
  '',
  '{',
